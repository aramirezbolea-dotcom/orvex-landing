...
const plans = [
  ...
  },
  {
    ...
    includes: [
      ...
      { text: "Soporte por teléfono y WhatsApp (respuesta en menos de 24 h)", included: true },
    ],
  ...
  },
  {
    ...
    includes: [
      ...
      { text: "Soporte directo por teléfono y WhatsApp (respuesta en menos de 24 h)", included: true },
    ],
